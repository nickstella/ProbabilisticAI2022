...
class EnsembleTrainer(Framework):
    def __init__(self, dataset_train,
        ...
        self.EnsembleNetworks.append(
            {'network_name': 'CNN1', 'network': SelfMadeNetwork(dropout_p=0.4), 'num_epochs': 20,
        ...
        self.EnsembleNetworks.append(
            {'network_name': 'CNN4', 'network': SelfMadeNetwork(dropout_p=0.4), 'num_epochs': 20,
             'learning_rate': 1e-3, 'batch_size': 256})
        self.EnsembleNetworks.append(
            {'network_name': 'CNN5', 'network': SelfMadeNetwork(dropout_p=0.4), 'num_epochs': 20,
             'learning_rate': 1e-3, 'batch_size': 512})
        self.EnsembleNetworks.append(
            {'network_name': 'CNN6', 'network': SelfMadeNetwork(dropout_p=0.5), 'num_epochs': 20,
             'learning_rate': 1e-3, 'batch_size': 32})
        self.EnsembleNetworks.append(
            {'network_name': 'CNN7', 'network': SelfMadeNetwork(dropout_p=0.5), 'num_epochs': 20,
             'learning_rate': 1e-3, 'batch_size': 64})
        self.EnsembleNetworks.append(
            {'network_name': 'CNN8', 'network': SelfMadeNetwork(dropout_p=0.5), 'num_epochs': 20,
             'learning_rate': 1e-3, 'batch_size': 128})
        self.EnsembleNetworks.append(
            {'network_name': 'CNN9', 'network': SelfMadeNetwork(dropout_p=0.45), 'num_epochs': 25,
             'learning_rate': 5e-4, 'batch_size': 64})
        self.EnsembleNetworks.append(
            {'network_name': 'CNN10', 'network': SelfMadeNetwork(dropout_p=0.45), 'num_epochs': 25,
